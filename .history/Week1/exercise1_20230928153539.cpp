...
int main(){
    ...
    if(isDilute){
        cout << "the dangerous goods may be washed down to a drain with a large quantity of water" << endl;
    }else{
        cout << "a need to avoid spillages from entering drains or water courses.";
    }
