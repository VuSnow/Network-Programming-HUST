...
void displayScoreBoard(){
    ...
    while (currentScoreBoard != nullptr) {
        if (currentScoreBoard->subjectID == subjectID && currentScoreBoard->semester == semesterID) {
            ...
            Student minStudent = currentScoreBoard->students[0];
            ...
            while (currentStudent != nullptr) {
                ...
                if(currentStudent->totalMark > maxStudent.totalMark){
                    maxStudent = *currentStudent;
                }
                if(currentStudent->totalMark < minStudent.totalMark){
            ...
            // cout << maxStudent.lastName << endl;
            // cout << minStudent.lastName << endl;
            double averageMark = totalMarks / numStudents;

            cout << "The student with the highest mark is: " << maxStudent.firstName << " " << maxStudent.lastName << endl;
            cout << "The student with the lowest mark is: " << minStudent.firstName << " " << minStudent.lastName << endl;
